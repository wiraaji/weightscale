...
void calibrateScale() {
  ...
  tft.setCursor(80, 30);
  tft.print("Kosongkan Timbangan");
  countdown(5000); // 2 seconds countdown
  scale.tare();
...
void countdown(int ms) {
  ...
  tft.fillRect(60, 60, 240, 20, TFT_BLACK); // Clear the countdown text after the loop
}
...
void printWeight() {
  ...
  mySerial.print("^A0N,40,40");   // Set font for second line (Font A, size 40)
...
float getStableWeight() {
  ...
  float stableWeight = (average <= 2) ? 0 : average;
